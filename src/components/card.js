...
class Card extends React.Component {
  ...
  render(){
    ...
    return (
        <div className={ this.props.status && this.props.status === 'showBack' ? "active-back card" : "card"} onClick={ () => this.props.handleClickFunction(this.props.card, this.props.owner, this.props.handId)} >
