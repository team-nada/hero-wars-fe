  ...
  render(){
    return (
      <React.Fragment>
        ...
        {(this.props.computerScore > this.props.playerScore) ? <p>Computer Wins</p> : (this.props.computerScore < this.props.playerScore) ? <p>Player Wins</p> : <p>Player and Computer Tie</p>}
